...
export const MedicationNotificationSettings = ({ onBack }: { onBack?: () => void }) => {
  ...
  return (
    ...
    >
      {/* ─── Header ─── */}
      <header className="px-6 py-5 border-b border-[var(--border)] bg-[var(--card)] shrink-0">
        <div
          className="flex items-center gap-1.5 mb-3 text-[var(--muted-foreground)]"
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Settings className="w-5 h-5" style={{ color: 'var(--accent-foreground)' }} />
          </div>
          <div>
            <h1
              className="text-[var(--foreground)]"
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6">
        <div className="max-w-[960px] mx-auto space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <SectionCard
              icon={
                <Smartphone className="w-[18px] h-[18px]" style={{ color: 'var(--primary)' }} />
              }
              title="웰체크 앱 전송 설정"
            >
              <div className="flex items-start justify-between gap-4">
              ...
              >
                <div className="flex gap-3">
                  <div
                    ...
                    style={{
                      backgroundColor: defaultAppSend ? 'var(--primary)' : 'var(--border)',
                    }}
                  >
                    <Smartphone
                      className="w-4 h-4"
                      style={{
                        color: defaultAppSend
          ...
          <div className="flex items-center justify-end gap-3 pt-4 pb-10">
            <button
              type="button"
              onClick={handleReset}
              className="flex items-center gap-1.5 px-5 py-2.5 rounded-[var(--radius-button)] border border-[var(--border)] bg-white text-[var(--foreground)] hover:bg-[var(--muted)] transition-colors"
              style={{
                fontFamily: 'var(--font-family-noto)',
                fontSize: 'var(--text-base)',
                fontWeight: 'var(--font-weight-medium)',
            ...
            <button
              ...
              onClick={handleSave}
              className={clsx(
                'flex items-center gap-1.5 px-6 py-2.5 rounded-[var(--radius-button)] transition-colors',
                saved
