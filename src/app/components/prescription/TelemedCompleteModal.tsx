...
interface TelemedCompleteModalProps {
  onConfirm: (hasSubstitute: boolean) => void;
  onClose: () => void;
}

export const TelemedCompleteModal: React.FC<TelemedCompleteModalProps> = ({ onConfirm, onClose }) => {
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-[460px] overflow-hidden">
        ...
        <div className="px-6 pt-6 pb-5">
          ...
          <p className="text-sm font-medium text-gray-700 mb-3">
            비대면 진료로 접수된 처방전에 대체조제된 항목이 있나요?
          </p>
        ...
        <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-gray-100">
          ...
          <button
            onClick={() => onConfirm(hasSubstitute)}
