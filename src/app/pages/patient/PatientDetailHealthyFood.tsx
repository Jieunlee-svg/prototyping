...
export const PatientDetailHealthyFood: React.FC<PatientDetailProps> = ({ onBack, patientId }) => {
  ...
  const [showSupplementSuggestion, setShowSupplementSuggestion] = useState(true);
    ...
    <div className="flex flex-col h-full bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden p-4 grid grid-cols-12 gap-4">
          ...
          <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-green-50 p-3 rounded-lg">
                <span className="text-xs text-green-600 font-medium block mb-1">혈당</span>
                <div className="flex items-end gap-1">
          ...
          <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
            <div className="flex justify-between items-center mb-3">
              <div className="flex items-center gap-2">
                ...
                <InfoTooltip text="웰체크 앱 > 홈 > 혈당" position="top" />
              </div>
              <select className="text-xs border-gray-200 rounded px-1 py-0.5 bg-gray-50 text-gray-600">
                <option>최근 1개월</option>
                <option>최근 3개월</option>
            ...
            <div className="h-40 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={glucoseData}>
                  ...
                  <YAxis domain={[60, 160]} tick={{ fontSize: 10 }} axisLine={false} tickLine={false} width={25} />
                  <Tooltip contentStyle={{ borderRadius: '8px', fontSize: '12px' }} />
                  <Line type="monotone" dataKey="value" stroke="#22c55e" strokeWidth={2} dot={<CustomLineDot />} activeDot={{ r: 4 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            <div className="mt-2 flex justify-end">
        ...
        <div className="col-span-5 bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col overflow-hidden">
          ...
          {/* AI 건기식 추천 Suggestion Card */}
          {showSupplementSuggestion && (
            <div className="mx-4 mb-3 p-4 bg-green-50 border border-green-200 rounded-xl shadow-sm relative animate-in fade-in slide-in-from-bottom-2">
              <div className="flex items-center gap-2 mb-3">
                <Sparkles size={16} className="text-green-600" />
                <span className="text-sm font-bold text-green-800">AI 건기식 추천 알림</span>
              </div>
              <div className="text-sm text-gray-800 space-y-3 mb-4 leading-relaxed">
                ...
                <div className="bg-white/60 p-3 rounded-lg border border-green-100">
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-0.5 text-xs">
                    <li>에너지 생성: 만성 피로 회복 및 활력 증진</li>
                    <li>신경 보호: 손발 저림 및 신경통 예방</li>
                    <li>합병증 관리: 혈관 건강 유지에 도움</li>
                  </ul>
                </div>
                <p className="font-bold text-green-900">
                  ✅ 전문가 추천: 당뇨약과 함께 '비타민 B군' 영양제를 병행하여 부족한 영양소를 채워주세요!
                </p>
                <a href="#" className="inline-block text-blue-600 hover:text-blue-800 hover:underline font-medium">
                  🛒 관련 추천 제품 바로가기: [링크 삽입]
                </a>
              </div>
              <div className="flex gap-2 justify-end">
                <button 
                  onClick={() => setShowSupplementSuggestion(false)}
                  className="px-4 py-2 text-sm text-gray-600 bg-white border border-gray-200 hover:bg-gray-50 rounded-lg transition-colors font-medium"
                >
                  건너뛰기
                </button>
                <button 
                  onClick={() => {
                    ...
                    // @ts-ignore
                    setChatMessages(prev => [...prev, newMessage]);
                    setShowSupplementSuggestion(false);
                  }}
                  className="px-4 py-2 text-sm bg-green-600 text-white rounded-lg font-bold hover:bg-green-700 transition-colors shadow-sm flex items-center gap-1.5"
                >
                  <Send size={14} />
                  환자에게 전송
                </button>
